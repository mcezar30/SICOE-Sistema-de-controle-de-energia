...
$kwh = ($potencialTotal/100) * ($tempoTotal/60);
$valorTotal = $kwh * 0.5098000;
$metaTotal = (($kwh * 0.5098000) * (100 - $metaReducao) )/100;
$metaPotencia = round(($potencialTotal * (100 - $metaReducao) )/100);
$sugestaoPotencia = round(($potencialTotal * 80 )/100);
$sugestaoTotal = (($kwh * 0.5098000) * 80 )/100;
?>
<div class="main-box">
    <section id="more-products" class="cont clearfix">
        ...
        <form method='post' class='product grid_4'>
            ...
            <div id="listaProd estimativa">
                <p>
                    <input type="text" name="xx" id="campodisable" disabled="disabled" value="Consumo (KW)            <?php echo $sugestaoPotencia;?>">
                    <br>
                </p>
                <p>
                    <input type="text" name="xx" id="campodisable" disabled="disabled" value="Total a pagar               R$ <?php echo round($sugestaoTotal, 2);?>">
                    <br>
                </p>
            </div>
        ...
        <form method='post' class='product grid_4'>
            ...
            <div id="listaProd estimativa">
                <p>
                    <input type="text" name="xx" id="campodisable" disabled="disabled" value="Consumo (KW)              <?php echo $metaPotencia;?>">
                    <br>
                </p>
                <p>
                    <input type="text" name="xx" id="campodisable" disabled="disabled" value="Total a pagar                 R$ <?php echo round($metaTotal);?>">
                    <br>
                </p>
            </div>
        ...
        <form method='post' class='product grid_4'>
            ...
            <div id="listaProd estimativa">
                <p>
                    <input type="text" name="xx" id="campodisable" disabled="disabled" value="         R$ <?php echo round($valorTotal, 2);?>">
                    <br>
                </p>
            </div>
                ...
                <div class="linha">
                    <table class="table table-striped table-bordered table-condensed table-hover">
                        ...
                        <tr role="row">
                            ...
                            <th>Consumo (KWh)</th>
                            <th>Sugestao de Consumo (KWh)</th>
                            <th>Meta de Consumo (KWh)</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
